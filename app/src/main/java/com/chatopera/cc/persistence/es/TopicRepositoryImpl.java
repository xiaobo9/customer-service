...
import com.chatopera.cc.persistence.es.mapper.XiaoEUKResultMapper;
...
//        QueryBuilder endFilter = QueryBuilders.boolQuery().should(QueryBuilders.missingQuery("endtime")).should(QueryBuilders.rangeQuery("endtime").from(new Date().getTime()));
        QueryBuilder beginFilter = QueryBuilders.boolQuery().should(QueryBuilders.rangeQuery("begintime").to(new Date().getTime()));
        QueryBuilder endFilter = QueryBuilders.boolQuery().should(QueryBuilders.rangeQuery("endtime").from(new Date().getTime()));
