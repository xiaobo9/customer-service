...
public class OrganController extends Handler {
    ...
    public ModelAndView userroledelete(
        ...
        if (id != null) {
            ...
            if (organUsers.size() > 1) {
                ...
                return request(super.pageTplResponse("redirect:/admin/organ/index.html?organ=" + organ + "&msg=not_allow_remove_user"));
            }
        }
        return request(super.pageTplResponse("redirect:/admin/organ/index.html?organ=" + organ));
    }
    ...
    public ModelAndView area(ModelMap map, HttpServletRequest request, @Valid String id) {
        ...
        return request(super.pageTplResponse("/admin/organ/area"));
    }
    ...
    public ModelAndView authsave(HttpServletRequest request, @Valid String id, @Valid String menus) {
        ...
        return request(
                super.pageTplResponse("redirect:/admin/organ/index.html?organ=" + organData.getId()));
    }
}