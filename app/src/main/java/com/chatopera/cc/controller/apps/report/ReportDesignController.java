...
public class ReportDesignController extends Handler {
    ...
    public ModelAndView index(ModelMap map, HttpServletRequest request, @Valid String q, @Valid String id) throws Exception {
        ...
        return request(super.pageTplResponse("/apps/business/report/design/index"));
    }
    ...
    public ModelAndView rtpl(ModelMap map, HttpServletRequest request, @Valid String tplname, @Valid String template,
        ...
        return request(super.pageTplResponse("/apps/business/report/design/element"));
    }
    ...
    @Menu(type = "report", subtype = "reportdesign")
    public ModelAndView element(HttpServletRequest request, @Valid String colindex, @Valid String id, @Valid String parentid) {
    ...
    public ModelAndView ltpl(ModelMap map, HttpServletRequest request, @Valid String template, @Valid String id,
        ...
        return request(super.pageTplResponse("/apps/business/report/design/layout"));
    }
    ...
    public ModelAndView ftpl(ModelMap map, HttpServletRequest request, @Valid String template,
        ...
        return request(super.pageTplResponse("/apps/business/report/design/filter"));
    }
    ...
    public ModelAndView modeldesign(ModelMap map, HttpServletRequest request, @Valid String id, @Valid String tabid, HashMap<String, String> semap)
        ...
        return request(super.pageTplResponse("/apps/business/report/design/modeldesign"));
    }
    ...
    public ModelAndView dataset(ModelMap map, HttpServletRequest request, @Valid String mid, @Valid String cubeid)
        ...
        if (!StringUtils.isBlank(cubeid)) {
            PublishedCube cube = publishedCubeRepository.findById(cubeid).orElse(null);
            map.put("cube", cube);
        }
    ...
    public ModelAndView dimensionadd(ModelMap map, HttpServletRequest request, @Valid String cubeid, @Valid String t, @Valid String dtype,
        ...
        ModelAndView view = request(super.pageTplResponse("/apps/business/report/design/modeldesign/add"));
        if (!StringUtils.isBlank(cubeid)) {
            PublishedCube cube = publishedCubeRepository.findById(cubeid).orElse(null);
            map.addAttribute("cube", cube);
        }
    ...
    public ModelAndView gettableid(ModelMap map, @Valid String tableid) {
        ...
        return request(super.pageTplResponse("/apps/business/report/design/modeldesign/fktableid"));
    }

    @RequestMapping("/values")
    @Menu(type = "report", subtype = "reportdesign")
    public ModelAndView values(HttpServletRequest request, @Valid String mid, @Valid String dsid,
                               @Valid String d, @Valid String dtype, @Valid String m, @Valid String f, @Valid String tabid) throws Exception {
        ReportModel model = this.getModel(mid, super.getOrgi(request));
        if (!StringUtils.isBlank(dsid)) {
            model.setPublishedcubeid(dsid);
        }
        PublishedCube cube = publishedCubeRepository.findById(dsid).orElse(null);
    ...
    public ModelAndView getelement(ModelMap map, HttpServletRequest request, @Valid String id, @Valid String publishedid, HashMap<String, String> semap) throws Exception {
        if (!StringUtils.isBlank(id)) {
            ...
            if (StringUtils.isNotBlank(model.getPublishedcubeid())) {
                ...
                if (cubeList.size() > 0) {
                    ...
                    if (canGetReportData(model, cube.getCube())) {
                        try {
                            ReportData reportData = reportCubeService.getReportData(model, cube.getCube(), request, true, semap);
                            map.addAttribute("reportData", reportData);
                        } catch (Exception ex) {
        ...
        return request(super.pageTplResponse("/apps/business/report/design/elementajax"));
    }

    private ReportModel getModel(String id, String orgi, String publishedid) {
        if (!StringUtils.isBlank(publishedid)) {
            PublishedReport publishedReport = publishedReportRes.findById(publishedid).orElse(null);
    ...
    public ModelAndView rfilteredit(ModelMap map, HttpServletRequest request, @Valid String fid) throws Exception {
        ...
        return request(super.pageTplResponse("/apps/business/report/design/filteredit"));
    }
    ...
    public ModelAndView filteredit(ModelMap map, HttpServletRequest request, @Valid String fid) {
        ...
        if (!StringUtils.isBlank(fid)) {
            ...
            if (rf != null) {
                if (!StringUtils.isBlank(rf.getCubeid())) {
                    PublishedCube cube = publishedCubeRepository.findById(rf.getCubeid()).orElse(null);
                    map.addAttribute("cube", cube);
                    List<MetadataTable> metadataTable = new ArrayList<>();
                    for (CubeMetadata cm : cube.getCube().getMetadata()) {
                        if ("0".equals(cm.getMtype())) {
        ...
        return request(super.pageTplResponse("/apps/business/report/design/modeldesign/filteredit"));
    }
    ...
    public ModelAndView fktableid(ModelMap map, HttpServletRequest request, @Valid String fid, @Valid String fkId) {
        ...
        return request(super.pageTplResponse("/apps/business/report/design/modeldesign/fktableiddiv"));
    }
    ...
    public ModelAndView columnedit(ModelMap map, HttpServletRequest request, @Valid String id) {
        ...
        return request(super.pageTplResponse("/apps/business/report/design/modeldesign/measureedit"));
    }
    ...
    public ModelAndView filtervalchange(ModelMap map, HttpServletRequest request, @Valid String id, @Valid String fid, @Valid String publishedid)
        ...
        return request(super.pageTplResponse("/apps/business/report/design/modeldesign/filter"));
    }
    ...
    public ModelAndView reportpublish(ModelMap map, @Valid String reportid) {
        ...
        return request(super.pageTplResponse("/apps/business/report/reportpublish"));
    }
    ...
    public ModelAndView reportpublished(ModelMap map, HttpServletRequest request, @Valid String reportid, @Valid String isRecover) throws Exception {
        ...
        if (!StringUtils.isBlank(reportid)) {
            ...
            return request(super.pageTplResponse("redirect:/apps/report/index.html?dicid=" + publishedReport.getDicid()));
        }
        return request(super.pageTplResponse("redirect:/apps/report/index.html"));
    }
}